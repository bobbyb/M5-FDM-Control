...
// Following function saves current AnkerStudio version into app config.
...
static std::string generate_system_info_json()
{
    ...
    pt::ptree data_node;
    data_node.put("AnkerStudioVersion", SLIC3R_VERSION);
           ...
           wxDEFAULT_DIALOG_STYLE)
{
    ...
    // Get current AnkerSliver version info.
    std::string app_name;
    {
    ...
    wxString text2 = GUI::format_wxstr(
        _L("We do not send any personal information nor anything that would allow us "
           ...
           "installation are sent. M5 FDM Control is open source, if you want to "
    ...
    wxString html = GUI::format_wxstr(
            ...
            "<table><tr><td>"
            "<img src = \"" + resources_dir() + "/icons/AnkerStudio_192px.png\" />"
            "</td><td align=\"left\">"
            + text0 + "<br / ><br / >"
            + text1 + "<br /><br />"
            "</td></tr></table>"
